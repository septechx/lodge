#include "compose_grab.hpp"

#include "src/render/utils.hpp"

GraphicsPipeline createComposeGrabPipeline(VkDevice device,
                                           VkFormat colorFormat,
                                           VkFormat depthFormat,
                                           const VkExtent2D &extent,
                                           VkDescriptorSetLayout setLayout) {

  ShaderModules modules = loadShaders(device, "build/compose_grab.vert.spv",
                                      "build/compose_grab.frag.spv");
